...
import '../controller/calculator_kkal_controller.dart';

class CalculatorKKalPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return GetBuilder<CalculatorkKalController>(
        init: CalculatorkKalController(
            ...
            body: Container(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      Expanded(
                        child: InkWell(
                          ...
                          child: GetX<CalculatorkKalController>(builder: (_) {
                            return CustomText(
                  ...
                  Row(
                    children: [
                      GetX<CalculatorkKalController>(builder: (_) {
                        return Expanded(
                          child: InkWell(
                            onTap: () {
