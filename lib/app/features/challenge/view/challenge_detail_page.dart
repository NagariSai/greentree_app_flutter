...
import 'package:fit_beat/app/features/challenge/controller/challenge_detail_controller.dart';
...
class ChallengeDetailPage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        bottom: true,
        child: GetBuilder<ChallengeDetailController>(
            init: ChallengeDetailController(
                                        ...
                                        Expanded(
                                          child: Column(
                                            ...
                                            children: [
                                              ...
                                              CustomText(
                                                text:
                                                    "${_.feedData.triedCount} people tried this challenge",
                                                            ...
                                                            child: Column(
                                                              ...
                                                              children: [
                                                                ...
                                                                comment.subComment
                                                                    ...
                                                                    ? ListView.builder(
                                                                        shrinkWrap: true,
                                                                        itemCount: comment.subComment.length,
  ...
  void _openDialog(BuildContext context) {
    ...
    var _ = Get.find<ChallengeDetailController>();
  ...
  Widget showReplyMode() {
    return GetBuilder<ChallengeDetailController>(builder: (_) {
      return InkWell(
        onTap: () {
          _.clearReplay();
        },
