...
import 'package:fit_beat/app/features/prog_tracker/views/insight_page.dart';
import 'package:fit_beat/app/features/prog_tracker/views/water_progress_page.dart';
...
class _ProgressTrackerPageState extends State<ProgressTrackerPage>
  ...
  final List<Widget> tabs = <Widget>[
    Container(height: 44, width: Get.width / 3, child: Tab(text: "Progress")),
    Container(height: 44, width: Get.width / 3, child: Tab(text: "Insights")),
  ];
