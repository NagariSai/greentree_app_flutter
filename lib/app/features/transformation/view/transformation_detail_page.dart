...
import 'package:fit_beat/app/features/transformation/controller/transformation_detail_controller.dart';
...
class TransformationDetailPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        bottom: true,
        child: GetBuilder<TransformationDetailController>(
            init: TransformationDetailController(
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            ...
                                            MediaSlidableWidget(
                                              ...
                                              duration: _.feedData.duration,
                                              lostKg: _.feedData.lostKgs,
                                            ),
                                            SizedBox(
                                              height: 8,
                                            ),
  ...
  Widget showReplyMode() {
    return GetBuilder<TransformationDetailController>(builder: (_) {
      return InkWell(
        onTap: () {
          _.clearReplay();
        },
  ...
  void _openDialog(BuildContext context) {
    ...
    var _ = Get.find<TransformationDetailController>();
