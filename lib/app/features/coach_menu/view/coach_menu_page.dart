...
import 'package:fit_beat/app/features/coach_menu/controllers/coach_menu_controller.dart';
import 'package:fit_beat/app/features/coach_menu/view/coach_settings_widget.dart';
...
class CoachMenuPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    var data = PrefData().getUserData();
    return Scaffold(
        body: GetBuilder<CoachMenuController>(
      init: CoachMenuController(
      ...
      builder: (_) => Column(
          ...
          children: [
            InkWell(
              onTap: () {
                Get.toNamed(Routes.coachProfilePage);
              },
              child: Padding(
                ...
                child: Row(
                  children: [
                    Obx(
                      () => CircularImage(
                        imageUrl: PrefData().isCoach()
                            ? Get.find<CoachMainController>().profileUrl.value
                          ...
                          return InkWell(
                            onTap: () {
                              if (position == 0) {
                                ...
                                Get.toNamed(Routes.coachPaymentPage);
                              }
                            },
  ...
  void _handleRedirection(String title, CoachMenuController menuController) {
