...
class CalculatorBMRController extends GetxController {
  final ApiRepository repository;

  CalculatorBMRController({@required this.repository})
  ...
  void showHeightPicker(BuildContext context) {
    ...
    if (selectedHeightUnit.value == HEIGHT_UNIT.CM) {
      ...
      Get.find<CalculatorBMRController>().showCMHeightPicker(context);
    } else {
      print("showFeetHeightPicker");
      Get.find<CalculatorBMRController>().showFeetHeightPicker(context);
    }
  }
