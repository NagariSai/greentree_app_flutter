...
import 'package:fit_beat/app/features/post_update/controller/post_update_detail_controller.dart';
...
class PostUpdateDetailPage extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        bottom: true,
        child: GetBuilder<PostUpdateDetailController>(
            init: PostUpdateDetailController(
  ...
  Widget showReplyMode() {
    return GetBuilder<PostUpdateDetailController>(builder: (_) {
      return InkWell(
        onTap: () {
          _.clearReplay();
        },
  ...
  void _openDialog(BuildContext context) {
    ...
    var _ = Get.find<PostUpdateDetailController>();
