...
import 'package:fit_beat/app/common_widgets/fl_chart/src/chart/base/axis_chart/axis_chart_painter.dart';
import 'package:fit_beat/app/common_widgets/fl_chart/src/chart/base/base_chart/base_chart_painter.dart';
import 'package:fit_beat/app/common_widgets/fl_chart/src/extensions/canvas_extension.dart';
import 'package:fit_beat/app/common_widgets/fl_chart/src/extensions/paint_extension.dart';
import 'package:fit_beat/app/common_widgets/fl_chart/src/extensions/path_extension.dart';
import 'package:fit_beat/app/common_widgets/fl_chart/src/utils/canvas_wrapper.dart';
import 'package:fit_beat/app/common_widgets/fl_chart/src/utils/utils.dart';
...
class LineChartPainter extends AxisChartPainter<LineChartData>
  ...
  void _drawTouchedSpotsIndicator(
    ...
    for (var i = 0; i < barData.showingIndicators.length; i++) {
      ...
      /// For drawing the dot
      final showingDots = indicatorData.touchedSpotDotData != null &&
